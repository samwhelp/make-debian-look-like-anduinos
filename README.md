...
* [Requirement](https://github.com/samwhelp/make-debian-look-like-anduinos/blob/main/requirement.md)
* [Keybind](https://github.com/samwhelp/make-debian-look-like-anduinos/blob/main/keybind.md)
* [Howto](#howto)
* [Extension](#extension)
* [Theme](#theme)
* [Wallpaper](#wallpaper)
...
``` sh
bash <(curl -L https://raw.githubusercontent.com/samwhelp/make-debian-look-like-anduinos/refs/heads/main/make-debian-look-like-anduinos.sh)
```
...
``` sh
bash <(wget -q https://raw.githubusercontent.com/samwhelp/make-debian-look-like-anduinos/refs/heads/main/make-debian-look-like-anduinos.sh -O - )
```
...
``` sh
bash -c "$(curl -fsSL https://raw.githubusercontent.com/samwhelp/make-debian-look-like-anduinos/refs/heads/main/make-debian-look-like-anduinos.sh || wget -q https://raw.githubusercontent.com/samwhelp/make-debian-look-like-anduinos/refs/heads/main/make-debian-look-like-anduinos.sh -O - )"
```
...
``` sh
bash -c "$(wget -q https://raw.githubusercontent.com/samwhelp/make-debian-look-like-anduinos/refs/heads/main/make-debian-look-like-anduinos.sh -O - || curl -fsSL https://raw.githubusercontent.com/samwhelp/make-debian-look-like-anduinos/refs/heads/main/make-debian-look-like-anduinos.sh)"
```
...
| anduinos-gnome-shell-adjustment | debian-gnome-shell-adjustment |
| ------------------------------- | ----------------------------- |
| [gnome-shell-layout-wincity.sh](https://github.com/samwhelp/anduinos-gnome-shell-adjustment/blob/main/demo/scripts/layout/gnome-shell-layout-wincity/gnome-shell-layout-wincity.sh) | [gnome-shell-layout-wincity.sh](https://github.com/samwhelp/debian-gnome-shell-adjustment/blob/main/demo/scripts/layout/gnome-shell-layout-wincity/gnome-shell-layout-wincity.sh) |
| [gnome-shell-layout-wincity](https://github.com/samwhelp/anduinos-gnome-shell-adjustment/tree/main/project/gnome-shell-layout/gnome-shell-layout-advance-full/profile/gnome-shell-layout-wincity) | [gnome-shell-layout-wincity](https://github.com/samwhelp/debian-gnome-shell-adjustment/tree/main/project/gnome-shell-layout/gnome-shell-layout-advance-full/profile/gnome-shell-layout-wincity) |
